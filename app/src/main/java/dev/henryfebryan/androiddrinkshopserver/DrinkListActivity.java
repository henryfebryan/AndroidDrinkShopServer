...
import dev.henryfebryan.androiddrinkshopserver.Utils.ProgressRequestBody;
import dev.henryfebryan.androiddrinkshopserver.Utils.UploadCallBack;
    ...
    private void showAddDrinkDialog() {
        ...
        builder.setNegativeButton("CANCEL", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                compositeDisposable.add(mService.addNewProduct(edt_drink_name.getText().toString(),uploaded_img_path,edt_drink_price.getText().toString(),Common.currentCategory.getID())
                        ...
                        .subscribe(new Consumer<String>() {
                            ...
                            public void accept(String s) throws Exception {
                                ...
                                loadListDrink(Common.currentCategory.getID());//refresh list
                                uploaded_img_path = "";
                                selected_uri = null;
                            }
                    ...
                    mService.uploadProductFile(body)
                            .enqueue(new Callback<String>() {
                                ...
                                public void onFailure(Call<String> call, Throwable t) {
                                    ...
                                    Log.d("ErrorIMGPATH",t.getMessage());
                                }
                            });
                }
            }).start();
